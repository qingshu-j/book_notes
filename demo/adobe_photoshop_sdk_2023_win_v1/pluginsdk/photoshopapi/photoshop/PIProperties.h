...
#define kGPUFlagsGPUPossible		0x0100	// GPU is capable of being used in Photoshop
#define kGPUFlagsCLCompute			0x0020
#define kGPUFlagsNativeGPUPossible  0x1000  // Native GPU support is available
#define kGPUFlagsNativeGPUEnabled   0x2000  // Native GPU checkbox is enabled

/**
*Plugin or feature can use this flag to determine whether OpenGL has to be preferred over Native.
This can be set via the gestalt.
*/
#define propGPULiquifyOGLForce		'LOGL'
