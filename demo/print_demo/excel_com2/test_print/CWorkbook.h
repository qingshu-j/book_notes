...
//#import "C:\\Program Files\\Microsoft Office\\Updates\\Download\\PackageFiles\\5887A4FA-42D3-490C-BBD2-5E5543BB4AEE\\root\\Office16\\EXCEL.EXE" no_namespace
// CWorkbook 包装器类
...
public:
	...
	{
		LPDISPATCH result;
		InvokeHelper(0xd33, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, NULL);
		return result;
	}
	long get_ExternalCodeServiceTimeout()
	{
		long result;
		InvokeHelper(0xd4e, DISPATCH_PROPERTYGET, VT_I4, (void*)&result, NULL);
		return result;
	}
	void put_ExternalCodeServiceTimeout(long newValue)
	{
		static BYTE parms[] = VTS_I4;
		InvokeHelper(0xd4e, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, parms, newValue);
	}
